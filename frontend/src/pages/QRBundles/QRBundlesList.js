              ...
              <tr key={bundle._id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                  <div className="flex items-center">
                    <DocumentIcon className="h-4 w-4 mr-1 text-gray-400" />
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                  {bundle.accessControl.expiryDate ? (
                    <span className={new Date(bundle.accessControl.expiryDate) < new Date() ? 'text-red-600' : ''}>
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8 flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">QR Bundles</h1>
      ...
      {loading ? (
                  ...
                  <div className="p-6">
                    {viewMode === 'table' ? (
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {group.items.map((bundle) => (
                        <div key={bundle._id} className="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                          ...
                          <div className="space-y-2 text-sm text-gray-500">
                            ...
                            <div className="flex items-center justify-between">
                              <span>Created</span>
                              <span>{format(new Date(bundle.createdAt), 'MMM dd, yyyy')}</span>
                            </div>
        ...
        // Ungrouped view with toggle between list and table
