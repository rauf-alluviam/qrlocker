    ...
    <div className="min-h-screen flex overflow-hidden bg-gray-50">
      ...
      <div className="hidden md:flex md:flex-shrink-0">
        <div className="flex flex-col w-64">
          <div className="flex flex-col h-0 flex-1 bg-gray-800 shadow-2xl">
            ...
            <div className="flex-shrink-0 flex border-t border-gray-700 p-4 bg-gray-800">
              <div className="flex-shrink-0 w-full group block">
                <div className="flex items-center">
                  <div>
                    <div className="inline-flex items-center justify-center h-10 w-10 rounded-lg bg-gray-700 text-white border border-gray-600 shadow-sm transition-all duration-200 group-hover:bg-gray-600 group-hover:scale-105">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-xs font-medium text-gray-300 group-hover:text-white transition-colors duration-200">
