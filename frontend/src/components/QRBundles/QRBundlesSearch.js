...
const QRBundlesSearch = ({
  ...
  return (
    <div className="mb-4 bg-white/90 backdrop-blur-sm rounded-lg shadow-sm border border-white/50 p-3">
      <form onSubmit={handleSearchSubmit} className="flex gap-2 mb-2">
        <div className="flex-1 relative">
          <MagnifyingGlassIcon className="h-4 w-4 absolute left-2.5 top-2.5 text-slate-400" />
          {searching && (
          ...
          <input
            ...
            className="w-full pl-9 pr-10 py-2 border border-slate-200/60 rounded-lg bg-white/90 backdrop-blur-sm focus:ring-1 focus:ring-blue-500/20 focus:border-blue-400 transition-all duration-200 text-slate-700 placeholder-slate-400 text-sm"
          />
        </div>
        <div className="flex gap-2">
          <select
            ...
            className="px-3 py-2 border border-slate-200/60 rounded-lg text-xs font-medium text-slate-700 bg-white/90 backdrop-blur-sm hover:bg-white focus:ring-1 focus:ring-blue-500/20 focus:border-blue-400 transition-all duration-200"
          >
            ...
            <option value="accessType">By Access Type</option>
          </select>
          <button
            type="button"
            onClick={handleToggleFilters}
            className="inline-flex items-center px-3 py-2 border border-slate-200/60 rounded-lg text-xs font-medium text-slate-700 bg-white/90 backdrop-blur-sm hover:bg-white hover:border-blue-300 transition-all duration-200"
          >
      ...
      {showFilters && (
        <div className="bg-slate-50/50 backdrop-blur-sm p-3 rounded-lg border border-slate-200/30">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            <div>
              ...
              <select
                ...
                className="w-full border border-slate-200/60 rounded px-2 py-1.5 bg-white/90 backdrop-blur-sm focus:ring-1 focus:ring-blue-500/20 focus:border-blue-400 transition-all duration-200 text-slate-700 text-xs"
              >
